public class Meat implements Food{
    ...
    /**
     * constructor with 7 arguments for meat class
     ...
     * if fat is greater than the sum contents of vitamin A, B, C and grams of protein then it is unhealthy, otherwise it is healthy.
     */
    public void setHealthy(){
        double vitTotal;

        vitTotal = this.vitaminA + this.vitaminC + this.vitaminB + this.protein;
        if(this.fat > vitTotal){
            isHealthy = false;
        }
        else{
            isHealthy = true;
